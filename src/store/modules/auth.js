  ...
  actions: {
    login(context, payload) {
      return new Promise((resolve, reject) => {
        axios
          .post(`https://${process.env.VUE_APP_API}/users/login`, payload)
          .then(result => {
            // console.log(result)
    ...
    getUsers(context) {
      return new Promise((resolve, reject) => {
        axios
          .get(
            `https://${process.env.VUE_APP_API}/users/${context.state.profileid}`
          )
          .then(result => {
    ...
    register(context, payload) {
      return new Promise((resolve, reject) => {
        console.log(payload)
        axios
          .post(`https://${process.env.VUE_APP_API}/users/register`, payload)
          .then(result => {
    ...
    editPassword(context, payload) {
      ...
      return new Promise((resolve, reject) => {
        axios
          .patch(
            `https://${process.env.VUE_APP_API}/users/editpass/${context.state.profileid}`,
            payload
          )
          .then(result => {
            resolve(result)
